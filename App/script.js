...
suivant.addEventListener("click",function(){
    ...
    if(i!=2 && i!=11 && i!=12 && i!=13 && i!=14 && i!=14 && i!=15 && i!=21 && i!=22 && i!=23)
    {
        ...
        <div class="form-group">
                <input class="main__form--input" type="radio" name="choix" value="oui" id="oui">
                <label class="main__form--label" for="oui">Oui</label>
                
            </div>
            <div class="form-group">
                <input class="main__form--input" type="radio" name="choix" value="non" id="non">
                <label class="main__form--label" for="non">non</label>
    ...
    else if(i==11)
    {
        ...
        else if(i==14)
        {
            form.innerHTML=`
            <div class="form-group">
                <label class="main__form--label" for="taille">Taille:</label>
                <input type="text" placeholder="taille" class="main__form--input" id="taille" name="taille">
            </div>
            <div class="form-group">
                <label class="main__form--label" for="poids">Poids:</label>
                <input type="text" placeholder="Poids" class="main__form--input" id="poids" name="poids">
            </div>
            `;
        }
        ...
        <div class="form-group">
            <input class="main__form--input" type="radio" name="choix" value="ne-sais-pas" id="ne-sais-pas">
            <label class="main__form--label" for="ne-sais-pas">ne sais pas</label>
        ...
        <div class="form-group">
            <input class="main__form--input" type="radio" name="choix" value="non-applicable" id="non-applicable">
            <label class="main__form--label" for="non-applicable">non applicable</label>
